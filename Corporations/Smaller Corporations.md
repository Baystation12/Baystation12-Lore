...
- **SAARE (Strategic Assault and Asset Retention Enterprises)**

SAARE is a very recently instated PMC specifically created for hire by private corporations which operate outside of the reach of normal law enforcement agencies. They are headquarted on a small offshore station in the neutral space near [Tiamat](https://baystation12.net/lore/Planets-and-Systems/Tiamat), in Alpha Centauri. Their contractors specialize in working in smaller, better trained units, rather than using the power of numbers. The company has taken to hiring veterans from both private and public militaries to get a jump start, but have begun instituting training programs to breed their own operatives for the future. SAARE owns and operates a small few armed gunboats for the purpose of ship escort, but the bulk of their force consists of planetary operatives. Typical assignments for SAARE contractors include private law enforcement, ship escort, location security, VIP escort, and VIP or asset recovery.

SAARE's investments have seen a large uptick since [NanoTrasen](https://baystation12.net/lore/Corporations/NanoTrasen) begun outsourcing part of their internal asset protection positions to the corporation. Being a neutral company, many corporations are beginning to see the advantage in using contractors with no government ties while operating in neutral space. Their services are still expensive and relatively sparsely used, so it may still be some time before the corporation can flourish.
